...
export default function Sidebar() {
  return (
    <aside className="hidden md:flex fixed inset-y-0 left-0 w-72 bg-[#191970]/95 backdrop-blur-xl flex-col p-6 rounded-r-3xl text-white">
      <h2 className="font-bold text-xl mb-1 text-white">ASTU Board</h2>
      <p className="text-on-surface-variant text-xs mb-6 text-white">Student Dashboard</p>
      ...
      <nav className="flex-1 space-y-2">
        ...
        <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant rounded-lg hover:bg-surface-container-high">
          <span className="material-symbols-outlined text-white">Notification</span>
        </a>
        <a className="flex items-center gap-3 px-4 py-3 text-on-surface-variant rounded-lg hover:bg-surface-container-high">
