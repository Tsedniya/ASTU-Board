        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" value={email} onChange={(e)=> setEmail(e.target.value)}placeholder="Name@gmail.com" required />
            </div>

            <div className="space-y-2">
              <Label htmlFor="password" className="text-gray-700" >Password</Label>
              <Input id="password" type="password" onChange={(e)=> setPassword(e.target.value)} value={password} placeholder="********" required minLength={8}/>
            </div>
          </CardContent>
